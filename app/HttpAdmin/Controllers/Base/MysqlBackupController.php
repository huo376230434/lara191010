...
use App\HttpAdmin\Extensions\AdminException;
use Encore\Admin\Grid\Displayers\Actions;
use Huojunhao\LaraAdmin\BaseExtends\Models\MysqlBackup;
...
class MysqlBackupController extends AdminBaseController
{
    ...
    protected function grid()
    {
        ...
        $grid->actions((function( Actions $action){
            ...
            $action->append(DoWithConfirm::obj('删除',url('admin/mysqlBackup/del'),$row->name)->isNormalLink()->setColorType('danger'));
    ...
    public function download($name)
    {
        ...
        try{
            if (!$name) {
                throw new AdminException("数据库名称不合法");
            }
    ...
    public function backup()
    {
        try{
            ...
            if (!is_writable($dir)) {
                throw new AdminException($dir . "没有写权限");
            }
    ...
    public function del()
    {
        ...
        try{
            ...
            if (!is_writable($full_name)) {
                throw new AdminException("没有写权限,需要在服务器上删除");
