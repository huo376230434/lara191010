...
namespace Huojunhao\LibDev\Faker;

use Faker\Factory;
use Huojunhao\LibDev\Faker\FakerTraits\FakerSentence;
use Huojunhao\LibDev\Faker\FakerTraits\FakerTest;
...
class HuoFaker {
use FakerSentence,FakerTest,Macroable;
...
//        return $this->chinese_faker->catchPhrase;
        return Arr::random($this->sentence_arr);
    }
